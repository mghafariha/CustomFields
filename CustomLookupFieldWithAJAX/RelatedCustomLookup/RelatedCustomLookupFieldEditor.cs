   ...
   public class RelatedCustomLookupFieldEditor : UserControl, IFieldEditor
{
    ...
    protected override void CreateChildControls()
    {
        ...
        if (!base.IsPostBack)
        {
            ...
            this.cbxAllowMultiple.Checked = this.isMulti;
        }
    }
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            if (lookup != null)
            {
                ...
                else
                {
                    ...
                    this.isMulti = lookup.AllowMultipleValues;
    ...
    public void OnSaveChange(SPField field, bool bNewField)
    {
        ...
        bool str9 = this.cbxAllowMultiple.Checked;
        RelatedCustomLookup lookup = field as RelatedCustomLookup;
        if (bNewField)
        {
            ...
            lookup.AllowMultipleValues = str9;
        }
        else
        {
